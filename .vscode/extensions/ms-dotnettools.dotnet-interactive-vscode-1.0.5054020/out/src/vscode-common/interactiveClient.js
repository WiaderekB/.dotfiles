...
class InteractiveClient {
    ...
    completion(kernelName, code, line, character) {
        ...
        return this.submitCommandAndGetResult(command, commandsAndEvents_1.CompletionsProducedType);
    }
    hover(language, code, line, character) {
        ...
        return this.submitCommandAndGetResult(command, commandsAndEvents_1.HoverTextProducedType);
    }
    signatureHelp(language, code, line, character) {
        ...
        return this.submitCommandAndGetResult(command, commandsAndEvents_1.SignatureHelpProducedType);
    }
    getDiagnostics(kernelName, code) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const diagsProduced = yield this.submitCommandAndGetResult(command, commandsAndEvents_1.DiagnosticsProducedType);
    ...
    requestValueInfos(kernelName) {
        ...
        return this.submitCommandAndGetResult(command, commandsAndEvents_1.ValueInfosProducedType);
    }
    requestValue(valueName, kernelName) {
        ...
        return this.submitCommandAndGetResult(command, commandsAndEvents_1.ValueProducedType);
    }
    cancel() {
    ...
    submitCommandAndGetResult(command, expectedEventType) {
        return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
            let handled = false;
            const token = command.getOrCreateToken();
            let disposable = this.subscribeToKernelTokenEvents(token, eventEnvelope => {
                var _a;
                if (((_a = eventEnvelope.command) === null || _a === void 0 ? void 0 : _a.hasSameRootCommandAs(command)) && eventEnvelope.eventType === expectedEventType) {
                    switch (eventEnvelope.eventType) {
                        case commandsAndEvents_1.CommandFailedType:
                            if (!handled) {
                                handled = true;
