...
function setCellKernelName(cell, kernelName) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield vscodeNotebookManagement.replaceNotebookCellMetadata(cell.notebook.uri, cell.index, mergedMetadata);
    });
}
...
function ensureCellKernelKind(cell, kind) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield vscodeNotebookManagement.replaceNotebookCells(cell.notebook.uri, new vscode.NotebookRange(cellIndex, cellIndex + 1), [newCellData]);
    ...
    return __awaiter(this, void 0, void 0, function* () {
        if (cell.kind === vscode.NotebookCellKind.Code) {
            if (cell.document.languageId !== constants.CellLanguageIdentifier) {
                ...
                yield vscodeNotebookManagement.replaceNotebookCells(cell.notebook.uri, new vscode.NotebookRange(cell.index, cell.index + 1), [updatedCellData]);
            }
        }
    });
}
