    ...
    redirectAndPublish(target, ...args) {
        if (this._kernelInvocationContext) {
            for (const arg of args) {
                ...
                const eventEnvelope = new commandsAndEvents.KernelEventEnvelope(commandsAndEvents.DisplayedValueProducedType, displayedValue, this._kernelInvocationContext.commandEnvelope);
