    ...
    provideDocumentSemanticTokens(document, _cancellationToken) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (notebookDocument) {
                    ...
                    if (cell) {
                        ...
                        if (tokenCount === 0 && text !== '') {
                            ...
                            polyglot_notebooks_1.Logger.default.info(`No tokens were produced for cell ${cell.index} of notebook ${notebookDocument.uri.toString()} with text: ${text}`);
                        }
                    }
                }
                ...
                polyglot_notebooks_1.Logger.default.warn(`Error generating dynamic semantic tokens: ${JSON.stringify(ex)}`);
