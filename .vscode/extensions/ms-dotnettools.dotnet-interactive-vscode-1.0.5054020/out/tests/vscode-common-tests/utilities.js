...
function createChannelConfig(channelCreator) {
    ...
    return Object.assign(Object.assign({}, defaultClientMapperConfig), { channelCreator: (uri) => __awaiter(this, void 0, void 0, function* () {
            const channel = yield channelCreator(uri);
            return { channel, kernelReady: {} };
        }) });
}
