...
describe('Acquisition tests', () => {
    ...
    it("simulate local tool exists, is out of date, and is updated to the auto version", () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, utilities_2.withFakeGlobalStorageLocation)(true, (globalStoragePath) => __awaiter(void 0, void 0, void 0, function* () {
            const args = {
                dotnetPath: 'dotnet',
            ...
            // prepopulate tool manifest...
            yield createEmptyToolManifest(args.dotnetPath, globalStoragePath);
            const launchOptions = yield (0, acquisition_1.acquireDotnetInteractive)(args, '42.42.42', // required version
    ...
    it("simulate local tool exists, is out of date, and is updated to the specified version", () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, utilities_2.withFakeGlobalStorageLocation)(true, (globalStoragePath) => __awaiter(void 0, void 0, void 0, function* () {
            const args = {
                dotnetPath: 'dotnet',
    ...
    it("simulate local tool exists and is already up to date", () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, utilities_2.withFakeGlobalStorageLocation)(true, (globalStoragePath) => __awaiter(void 0, void 0, void 0, function* () {
            ...
            yield installInteractiveTool({ dotnetPath: 'dotnet', toolVersion: '42.42.42' }, globalStoragePath);
            const launchOptions = yield (0, acquisition_1.acquireDotnetInteractive)(args, '42.42.42', // required version
            globalStoragePath, getInteractiveVersionThatReturnsSpecificValue('42.42.42'), // report existing version 42.42.42 is installed
            createToolManifestThatThrows, // throw if acquisition tries to create another manifest
    ...
    it("simulate local tool exists and is newer than required; version is downgraded", () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, utilities_2.withFakeGlobalStorageLocation)(true, (globalStoragePath) => __awaiter(void 0, void 0, void 0, function* () {
            const args = {
                dotnetPath: 'dotnet',
                toolVersion: '42.42.42', // install exactly this
