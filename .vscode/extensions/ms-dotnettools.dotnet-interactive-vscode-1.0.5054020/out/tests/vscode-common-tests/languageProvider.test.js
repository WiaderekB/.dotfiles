...
describe('LanguageProvider tests', () => {
    it('CompletionProvider', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const completion = yield (0, completion_1.provideCompletion)(clientMapper, 'csharp', uri, code, position, 0);
    ...
    it('HoverProvider', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const hover = yield (0, hover_1.provideHover)(clientMapper, 'csharp', uri, code, position, 0);
    ...
    it('SignatureHelpProvider', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        const sigHelp = yield (0, signatureHelp_1.provideSignatureHelp)(clientMapper, 'csharp', uri, code, position, 0);
