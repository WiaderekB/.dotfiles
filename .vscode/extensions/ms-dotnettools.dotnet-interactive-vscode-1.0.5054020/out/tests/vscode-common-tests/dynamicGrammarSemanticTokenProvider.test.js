...
describe('dynamic grammar tests', () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let languageConfigurationByPath;
    const testUri = {
    ...
    polyglot_notebooks_1.Logger.configure('test-host', (entry) => {
...
# Perl comment`;
    ...
    it('http grammar can classify code', () => __awaiter(void 0, void 0, void 0, function* () {
        const updatedKernelInfos = [
            {
                isComposite: false,
                isProxy: false,
...
User-Agent: abc/{{userAgent}}/def`;
        const tokens = yield getTokens('httpRequest', code);
        (0, chai_1.expect)(tokens).to.deep.equal([
            {
    ...
    it('markdown grammar can classify code', () => __awaiter(void 0, void 0, void 0, function* () {
        const code = `
#!markdown
This is \`markdown\`.
`;
    ...
    it('language configuration can be pulled from kernel name', () => {
        ...
        (0, chai_1.expect)(languageConfiguration).to.deep.equal({
            comments: {
                lineComment: '//'
            }
        });
    ...
    beforeEach(() => __awaiter(void 0, void 0, void 0, function* () {
        ...
        dynamicTokenProvider = new dynamicGrammarSemanticTokenProvider_1.DynamicGrammarSemanticTokenProvider(packageJSON, testExtensionGrammars, _path => true, path => getFileContents(path));
...
describe('deserializing language configuration tests', () => {
    ...
    function getConfigurationFromObject(obj) {
        const asString = JSON.stringify(obj);
        const config = (0, dynamicGrammarSemanticTokenProvider_1.parseLanguageConfiguration)(asString);
        return config;
    }
    function verifyIsRegExp(obj) {
        (0, chai_1.expect)(obj.constructor.name).to.equal('RegExp');
    }
