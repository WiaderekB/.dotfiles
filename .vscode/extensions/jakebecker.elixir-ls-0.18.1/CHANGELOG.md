...
- The extension reports errors and usage data via VSCode telemetry. Refer to [README.md#Telemetry](https://github.com/elixir-lsp/vscode-elixir-ls/blob/HEAD/README.md#Telemetry)
