"use strict";var __values=this&&this.__values||function(e){var t="function"==typeof Symbol&&Symbol.iterator,o=t&&e[t],r=0;if(o)return o.call(e);if(e&&"number"==typeof e.length)return{next:function(){return e&&r>=e.length&&(e=void 0),{value:e&&e[r++],done:!e}}};throw new TypeError(t?"Object is not iterable.":"Symbol.iterator is not defined.")},events_1=require("events"),device_1=require("./device"),usb=require("./bindings");usb.INIT_ERROR&&console.warn("Failed to initialize libusb."),Object.setPrototypeOf(usb,events_1.EventEmitter.prototype),Object.getOwnPropertyNames(device_1.ExtendedDevice.prototype).forEach((function(e){Object.defineProperty(usb.Device.prototype,e,Object.getOwnPropertyDescriptor(device_1.ExtendedDevice.prototype,e)||Object.create(null))}));var pollTimeout=500,hotplugSupported=usb._getLibusbCapability(usb.LIBUSB_CAP_HAS_HOTPLUG)>0,pollingHotplug=!1,pollDevices=new Set,pollHotplug=function(e){var t,o,r,l;if(void 0===e&&(e=!1),e)pollingHotplug=!0;else if(!pollingHotplug)return;var n=new Set(usb.getDeviceList());if(!e){try{for(var i=__values(n),u=i.next();!u.done;u=i.next()){var s=u.value;pollDevices.has(s)||usb.emit("attach",s)}}catch(e){t={error:e}}finally{try{u&&!u.done&&(o=i.return)&&o.call(i)}finally{if(t)throw t.error}}try{for(var a=__values(pollDevices),p=a.next();!p.done;p=a.next())s=p.value,n.has(s)||usb.emit("detach",s)}catch(e){r={error:e}}finally{try{p&&!p.done&&(l=a.return)&&l.call(a)}finally{if(r)throw r.error}}}pollDevices=n,setTimeout((function(){pollHotplug()}),pollTimeout)};usb.on("newListener",(function(e){"attach"!==e&&"detach"!==e||0===usb.listenerCount("attach")+usb.listenerCount("detach")&&(hotplugSupported?usb._enableHotplugEvents():pollHotplug(!0))})),usb.on("removeListener",(function(e){"attach"!==e&&"detach"!==e||0===usb.listenerCount("attach")+usb.listenerCount("detach")&&(hotplugSupported?usb._disableHotplugEvents():pollingHotplug=!1)})),module.exports=usb;
// SIG // Begin signature block
// SIG // MIIoPwYJKoZIhvcNAQcCoIIoMDCCKCwCAQExDzANBglg
// SIG // hkgBZQMEAgEFADB3BgorBgEEAYI3AgEEoGkwZzAyBgor
// SIG // BgEEAYI3AgEeMCQCAQEEEBDgyQbOONQRoqMAEEvTUJAC
// SIG // AQACAQACAQACAQACAQAwMTANBglghkgBZQMEAgEFAAQg
// SIG // ONiAgJpVW5fuBkS9N/UCextiXeNoiIWA1VqH//f62P6g
...
// SIG // BgorBgEEAYI3AgEVMC8GCSqGSIb3DQEJBDEiBCD7zzFH
// SIG // QbsTDGudTXPQXg44rb/3U+KSd7qwXSV1jnKLZTBCBgor
// SIG // BgEEAYI3AgEMMTQwMqAUgBIATQBpAGMAcgBvAHMAbwBm
// SIG // AHShGoAYaHR0cDovL3d3dy5taWNyb3NvZnQuY29tMA0G
// SIG // CSqGSIb3DQEBAQUABIIBABBMqyUm/5k1ePOfz9pq3qAZ
// SIG // m8lXaunDps26YuNdEhqSYJpkprHEkUFUlN70RsG4H0wO
// SIG // wPzkh5H+8NeLKDnAtbvE4madcEniz2mEuChAHDgqg3Ad
// SIG // tr+ZV1TMFwjttNGFIW3QtaWIotYrd/PL8+KBBzjLOsRi
// SIG // XbbYFRIR9YrmWQzzeHJHnjpjdCFVNX2HGvLTE5M5BUxu
// SIG // BXj76kBfgFhq0yaoA95EXt7bn1RE+PYte5U81JsaV2vA
// SIG // YYS2iHcYx2XKrXCkc8dpzpP8Ynthb4ZxfcRO+J+awysj
// SIG // dQy5YOO76rNRM91hkgEAgPuJFgSXSqzDVXE0NqxBkiPP
// SIG // /gYxCI7Iw0mhgheWMIIXkgYKKwYBBAGCNwMDATGCF4Iw
...
// SIG // AgEFAAQgK2iH0x5UvqJJNz36/26xGowMnx+6rxE8NcL4
// SIG // 14bOBbECBmV69yHYwhgSMjAyNDAxMDYwMjE5MTIuMDFa
...
// SIG // MA0GCSqGSIb3DQEBCwUAAgUA6UMcKTAiGA8yMDI0MDEw
// SIG // NjAwMjQwOVoYDzIwMjQwMTA3MDAyNDA5WjB3MD0GCisG
// SIG // AQQBhFkKBAExLzAtMAoCBQDpQxwpAgEAMAoCAQACAhKq
// SIG // AgH/MAcCAQACAhLiMAoCBQDpRG2pAgEAMDYGCisGAQQB
// SIG // hFkKBAIxKDAmMAwGCisGAQQBhFkKAwKgCjAIAgEAAg